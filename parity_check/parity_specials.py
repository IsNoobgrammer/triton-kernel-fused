...
cuBLAS grouped path -- against an INDEPENDENT plain-PyTorch reference, forward and all four grads.
    ...
    python parity_check/parity_specials.py            # needs CUDA (Triton kernels)
"""
import sys
...
def main():
    ...
    # 6 GLU (silu/normsilu alternating; radial needs act_params, covered by parity_radial) + 2 +Identity + 2 -Identity -- both signs, multi-expert blocks
    codes = [0, 2, 0, 2, 0, 2, 3, 3, 4, 4]
    E, e_glu = len(codes), 6
