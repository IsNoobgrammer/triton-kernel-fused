...
STEPS_BY_AXIS = {"v20": STEPS_10K, "v21": STEPS_10K, "v21_5": STEPS_10K, "xo": STEPS_10K,
                 "v23": STEPS_10K, "xoema": STEPS_10K}
DECAYFRAC_BY_AXIS = {"v21": 0.0, "v21_5": 0.0, "xo": 0.0, "v23": 0.0, "xoema": 0.0}   # const-LR axes (default WSD = 0.2)
...
# --- AXIS: aurora_ema + xorth 0.01 ns8 8-seed spread (xoema) - the killer combo -----------------
# SEEDS8 const-LR 10k. mean 0.429; 8/8 emerge (NO stall). s2 (the v23 ema STALL, d2 0.023) is
# RESCUED -> deepest seed (d2 0.547). xorth removes the ema failure mode AND deepens composition:
# ex-best-seed (n=7) 0.433/d2 0.411 still beats ema ex-stall (n=7) 0.450/d2 0.371. d4 0.114 = 2.5x base.
RUNS_XOEMA = {
 "seed 23": dict(c="s23", s=0, frac=[.998,.793,.713,.694,.550,.495,.473,.462,.451,.452,.443],
    d1=[.012,.214,.219,.284,.924,.935,.940,.940,.941,.939,.941], d2=[.014,.020,.040,.062,.111,.186,.264,.298,.325,.323,.344],
    d3=[.018,.018,.024,.023,.037,.072,.105,.119,.144,.151,.158], d4=[.018,.018,.017,.019,.020,.037,.048,.056,.068,.073,.079],
    dfin=[.941,.344,.158,.079,.043,.020], spec=[.14,.20,.08], eff=[7.8,7.3,7.6]),
 "seed 24": dict(c="s24", s=0, frac=[.997,.761,.671,.538,.490,.469,.457,.442,.419,.413,.405],
    d1=[.013,.230,.391,.646,.879,.939,.943,.942,.942,.939,.943], d2=[.016,.024,.071,.178,.250,.282,.333,.392,.497,.516,.522],
    d3=[.017,.019,.027,.070,.094,.109,.135,.155,.228,.252,.270], d4=[.014,.015,.017,.031,.034,.049,.053,.063,.086,.106,.107],
    dfin=[.943,.522,.270,.107,.053,.024], spec=[.02,.23,.17], eff=[7.9,7.8,7.8]),
 "seed 12": dict(c="s12", s=0, frac=[.997,.870,.702,.585,.570,.532,.482,.463,.443,.439,.431],
    d1=[.018,.240,.612,.910,.932,.941,.937,.940,.943,.933,.941], d2=[.018,.024,.043,.128,.146,.180,.279,.354,.425,.454,.461],
    d3=[.017,.019,.021,.028,.036,.053,.100,.118,.177,.206,.218], d4=[.016,.017,.019,.022,.023,.022,.038,.050,.075,.085,.097],
    dfin=[.941,.461,.218,.097,.045,.031], spec=[.25,.20,.17], eff=[7.7,7.4,7.7]),
 "seed 2 (RESCUED)": dict(c="s2", s=0, frac=[.998,.803,.651,.576,.566,.563,.520,.425,.411,.408,.404],
    d1=[.011,.455,.703,.926,.936,.939,.942,.937,.942,.941,.947], d2=[.017,.029,.091,.137,.142,.146,.206,.529,.547,.548,.547],
    d3=[.019,.021,.023,.028,.038,.039,.062,.284,.315,.319,.316], d4=[.014,.018,.019,.021,.021,.025,.027,.143,.169,.184,.176],
    dfin=[.947,.547,.316,.176,.110,.055], spec=[.07,.15,.14], eff=[7.8,7.4,7.4]),
 "seed 9": dict(c="s9", s=0, frac=[.997,.836,.729,.719,.588,.489,.451,.440,.420,.410,.408],
    d1=[.011,.190,.258,.272,.607,.900,.934,.942,.945,.945,.945], d2=[.019,.019,.020,.023,.098,.324,.436,.443,.488,.518,.532],
    d3=[.016,.017,.021,.023,.046,.165,.267,.290,.301,.311,.308], d4=[.015,.017,.016,.017,.026,.086,.145,.172,.178,.181,.173],
    dfin=[.945,.532,.308,.173,.099,.062], spec=[.01,.15,.13], eff=[8.0,7.6,7.8]),
 "seed 28": dict(c="s28", s=0, frac=[.997,.788,.722,.697,.605,.543,.496,.477,.472,.465,.462],
    d1=[.011,.192,.232,.290,.789,.875,.925,.929,.931,.939,.936], d2=[.017,.021,.027,.072,.089,.132,.183,.225,.234,.261,.267],
    d3=[.017,.018,.017,.025,.032,.050,.087,.102,.112,.117,.134], d4=[.015,.019,.017,.019,.022,.023,.034,.051,.054,.054,.062],
    dfin=[.936,.267,.134,.062,.035,.022], spec=[.08,.13,.18], eff=[7.7,7.7,7.3]),
 "seed 69": dict(c="s69", s=0, frac=[.997,.838,.679,.590,.553,.487,.474,.460,.455,.457,.451],
    d1=[.014,.308,.628,.891,.927,.940,.937,.940,.942,.943,.942], d2=[.015,.021,.076,.130,.154,.215,.249,.284,.284,.263,.292],
    d3=[.017,.020,.021,.034,.037,.085,.096,.138,.129,.128,.148], d4=[.014,.018,.016,.018,.018,.041,.048,.066,.069,.080,.074],
    dfin=[.942,.292,.148,.074,.046,.032], spec=[.22,.11,.16], eff=[7.3,7.7,7.8]),
 "seed 2026": dict(c="s2026", s=0, frac=[.997,.893,.738,.728,.660,.612,.533,.501,.483,.462,.431],
    d1=[.016,.088,.205,.264,.585,.827,.893,.918,.928,.929,.935], d2=[.016,.017,.021,.028,.048,.057,.113,.156,.222,.355,.461],
    d3=[.018,.021,.020,.019,.026,.028,.048,.074,.095,.163,.276], d4=[.015,.017,.017,.019,.022,.023,.031,.043,.049,.080,.148],
    dfin=[.935,.461,.276,.148,.081,.036], spec=[.16,.07,.17], eff=[7.8,7.7,7.4]),
}
COL_XOEMA = {c: plt.cm.tab10(i) for i, c in enumerate(_V23C)}
CFGS_XOEMA = _V23C
CLABEL_XOEMA = {"s23": "s23", "s24": "s24", "s12": "s12", "s2": "s2 RESCUED", "s9": "s9",
                "s28": "s28", "s69": "s69", "s2026": "s2026"}

AXES = [
    ("xoema", "aurora_ema + xorth 0.01 ns8 - 8 SEEDS (SEEDS8) @ CONST-LR 10k - mean 0.429; 8/8 EMERGE "
     "(no stall); s2 RESCUED (d2 0.023->0.547); beats ema even ex-best-seed", RUNS_XOEMA, COL_XOEMA,
     CFGS_XOEMA, CLABEL_XOEMA),
